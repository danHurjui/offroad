...
export interface LoadedReport {
  ...
  period: ReportPeriod
  /** The organisation's vehicles in the report — all of them, or the one asked for. */
  vehicles: Vehicle[]
...
export async function loadReport(
  ...
  const all = await prisma.vehicle.findMany({ where: { organizationId }, orderBy: { createdAt: 'asc' } })
